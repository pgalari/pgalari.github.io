...
const orbes = [
    ...
    { id: "orb7", tipo: "orbital", x: 250, y: 450, color: "#fb0202", orden:7, caos:7, ordenM:1, nombre: "Orb 7", mandala: "Vocación", descripcion: "Servicio", frecuencia: "", situacion: "Orbita alrededor de la muñeca de la mano dominante", conecta: "Tallo Cerebral", mudra: "", respiracion: "", breve: "Es el sistema de memoria de servicio", ampliado: "Est" },
    { id: "orb8", tipo: "orbital", x: 450, y: 450, color: "#f7941f", orden:8, caos:8, ordenM:12, nombre: "Orb 8", mandala: "Social", descripcion: "Relaciones", frecuencia: "", situacion: "Orbita alrededor de la muñeca de la mano no dominante", conecta: "Tallo Cerebral", mudra: "", respiracion: "", breve: "Es el sistema de memoria de servicio", ampliado: "Est"  },
    { id: "orb9", tipo: "orbital", x: 250, y: 350, color: "#FFDE21", orden:9, caos:9, ordenM:11, nombre: "Orb 9", mandala: "Motivación", descripcion: "Habilidades", frecuencia: "", situacion: "Orbita alrededor del codo de la mano dominante", conecta: "Cordón Espinal", mudra: "", respiracion: "", breve: "Es el sistema de memoria de servicio", ampliado: "Est" },
    { id: "orb10", tipo: "orbital", x: 450, y: 350, color: "#02a550", orden:10, caos:10, ordenM:10, nombre: "Orb 10", mandala: "Pareja", descripcion: "Pareja", frecuencia: "", situacion: "Orbita alrededor del codo de la mano no dominante", conecta: "Cordón Espinal", mudra: "", respiracion: "", breve: "Es el sistema de memoria de servicio", ampliado: "Est" },
    { id: "orb11", tipo: "orbital", x: 250, y: 250, color: "#0071bd", orden:11, caos:11, ordenM:9, nombre: "Orb 11", mandala: "Propósito", descripcion: "Propósito", frecuencia: "", situacion: "Orbita alrededor del hombro de la mano dominante", conecta: "Sistema Nervioso Periférico", mudra: "", respiracion: "", breve: "Es el sistema de memoria de servicio", ampliado: "Est" },
    { id: "orb12", tipo: "orbital", x: 450, y: 250, color: "#902692", orden:12, caos:12, ordenM:8, nombre: "Orb 12", mandala: "Tribu", descripcion: "Familia", frecuencia: "", situacion: "Orbita alrededor del hombro de la mano no dominante", conecta: "Sistema Nervioso Periférico", mudra: "", respiracion: "", breve: "Es el sistema de memoria de la supervivencia y Familiar", ampliado: "Est" }
];
