...
const orbes = [
    ...
    { id: "orb11", tipo: "exterior", x: 250, y: 250, color: "#0071bd", orb:11, ordenM:9, mandala: "Filosofía", nombre: "Propósito", frecuencia: "Delta", situacion: "Orbita alrededor del hombro de la mano dominante", conecta: "Sistema Nervioso Periférico", mudra: "", respiracion: "Delta", breve: "Es el sistema de memoria de servicio", ampliado: "Este sistema de memoria, nos permite vivir con propósito, gracias a nuestra vocación y habilidades en consonancia con nuestra filosofia de vida." },
    { id: "orb12", tipo: "exterior", x: 450, y: 250, color: "#902692", orb:12, ordenM:8, mandala: "Tribu", nombre: "Familia", frecuencia: "Delta", situacion: "Orbita alrededor del hombro de la mano no dominante", conecta: "Sistema Nervioso Periférico", mudra: "", respiracion: "Delta", breve: "Es el sistema de memoria de la supervivencia y Familiar", ampliado: "Este sistema de memoria, guarda nuestra interacción que sostiene nuestra vida, nuestra familia original y si la creamos nuestra tribu social elegida." }
];
...
const lineas = [
  ...
  { de: "orb6", a: "orb7", width: 3 },
  { de: "orb7", a: "orb8", width: 3 },
  { de: "orb8", a: "orb9", width: 2 },  // más fina
  { de: "orb9", a: "orb10", width: 2 },
  { de: "orb10", a: "orb11", width: 2 },
  { de: "orb11", a: "orb12", width: 2 }
];
const contenidos = {
  que: {
    textos: {
